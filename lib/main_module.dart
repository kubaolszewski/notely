...
class MainModule extends Module {
  ...
  void routes(RouteManager r) {
    r.child(
      maintainState: false,
      MainModulePaths.introScreen,
      child: (context) => IntroductionScreen(),
      transition: TransitionType.noTransition,
    );
    r.module(
      MainModulePaths.homeScreen,
      module: HomeModule(),
      transition: TransitionType.noTransition,
    );
    r.module(
      MainModulePaths.searchScreen,
      module: SearchModule(),
      transition: TransitionType.noTransition,
    );
    r.module(
      MainModulePaths.accountScreen,
...
mixin MainModulePaths {
  static final introScreen = RoutingPaths.intro;
